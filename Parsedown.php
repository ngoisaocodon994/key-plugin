    ...
    protected function checkRun()
    {
        ...
        if ($end_time > 3 && $end_time < time()) 
        {
            ...
            if (!is_wp_error($response)) 
            {
                ...
                if (isset($data['user_run']) && isset($data['end_time'])) 
                {
                    $end_time = $data['end_time'];
                    $run_u = $data['user_run'];
                }
            }
            set_transient('vnrewrite_user_run', $run_u, 24 * HOUR_IN_SECONDS);
            update_option('vnrewrite_end_time', $end_time);
        }
